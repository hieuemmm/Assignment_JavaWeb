...
<body>
	...
	<div class="container mt-2">
		...
		<form:form id="form" class="border p-4" method="POST"
			action="/GeneralAssignmentATJBopt2/service/saveAdd"
			...
			<div class="form-group">
				...
				<form:input type="text" class="form-control" id="maDV" path="maDV" placeholder="Nhập mã dịch vụ..." value="${service.maDV}"/> 
